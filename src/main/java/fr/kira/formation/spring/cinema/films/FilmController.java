...
public class FilmController {
    ...
    // trouvé par date rechercher
    @GetMapping("parDate/{dateRechercher}")
    public List<Film> findFilmByDate(@PathVariable LocalDate dateRechercher) {
        return this.service.findByDate(dateRechercher);
    }
